...
@Component({
  selector: 'noc-term-cams',
  templateUrl: './term-cams.component.html',
  styleUrls: ['./term-cams.component.scss'],
  animations: noctuaAnimations,
})
export class TermCamsComponent implements OnInit, OnDestroy {
