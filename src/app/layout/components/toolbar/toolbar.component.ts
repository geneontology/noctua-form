    ...
    constructor(
        ...
        this.route
            ...
            .subscribe(params => {
                ...
                this.loginUrl = `${environment.globalBaristaLocation}/login?return=${this.noctuaFormUrl}`;
                this.logoutUrl = `${environment.globalBaristaLocation}/logout?return=${this.noctuaFormUrl}`;
